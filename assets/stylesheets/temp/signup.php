...
<body class="no-skin">
        ...
        <div class="modal-content">
            ...
            <h4>Please confirm in your email.</h4>
            </div>
        </div>
                    ...
                    <div class="col-lg-6 col-md-12 ">
                            <div class="col-lg-12 justify-content-center align-items-center">
                                    ...
                                    <h6>Please enter the required information below.</h6>
                                        ...
                                        <div class="input-group col-md-10 input-group-md">
                                            <input name="lastName" value="<?php echo $this->session->flashdata('lastName'); ?>" data-validation="alphanumeric" id="lastName" placeholder='Last Name' class='form-control'  data-validation-allowing=" " data-validation-error-msg="Please enter Last Name" data-validation-error-msg-container="#messageValidationLocationLastName" onBlur="" onFocus="" >
                                        </div>
                                        <span>
                                        ...
                                        <div class="input-group col-md-10 input-group-md">
                                            <input name="firstName" value="<?php echo $this->session->flashdata('firstName'); ?>" data-validation="alphanumeric" id="firstName" placeholder='First Name' class='form-control'  data-validation-allowing=" " data-validation-error-msg="Please enter First Name" data-validation-error-msg-container="#messageValidationLocationFirstName" onBlur="" onFocus="" >
                                        </div>
                                        <span>
                                        ...
                                        <div class="input-group col-md-10 input-group-md">
                                            <input name="middleName" value="<?php echo $this->session->flashdata('middleName'); ?>" data-validation="alphanumeric" id="middleName" placeholder='Middle Name' class='form-control'  data-validation-allowing=" " data-validation-error-msg="Please enter Middle Name" data-validation-error-msg-container="#messageValidationLocationMiddleName" onBlur="" onFocus="" >
                                        </div>
                                        <span>
    ...
    <div class="col-12  p-10">
        ...
        <div class="footer">
						<div class="social-media">
							...
							<br /> 	&nbsp; &nbsp;
							<a href="https://www.facebook.com" target="_blank"> <img src="../assets/images/facebook-logo.png"></img></a>
							<a href="https://www.twitter.com" target="_blank"> <img src="../assets/images/twitter-logo.png"></img></a>
						</div>
