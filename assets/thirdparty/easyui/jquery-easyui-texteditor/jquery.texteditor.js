			...
			'insertimage': {
				...
				onClick: function(){
					var content = 
							...
							'<input class="easyui-textbox img-src" label="Source:" labelAlign="right" style="width:100%">' +
							'</div>' +
							'<div style="margin-bottom:20px">' +
							'<input class="easyui-textbox img-alt" label="Description:" labelAlign="right" style="width:100%">' +
							'</div>' +
							'<div style="margin-bottom:20px">' +
							'<input class="easyui-numberbox img-width" label="Width:" labelAlign="right" style="width:50%">' +
							'<input class="easyui-numberbox img-height" label="Height:" labelAlign="right" style="width:50%">' +
							'</div>' +
							'</div>';
			...
			'insertlink': {
				...
				onClick: function(){
					var content = 
							...
							'<div style="margin-bottom:20px">' +
							'<input class="easyui-textbox link-url" label="Url:" labelAlign="right" validType="url" style="width:100%">' +
							'</div>' +
							'<div style="margin-bottom:20px">' +
							'<input class="easyui-textbox link-text" label="Text:" labelAlign="right" style="width:100%">' +
							'</div>' +
							'<div style="margin-bottom:20px">' +
							'<input class="easyui-textbox link-title" label="Title:" labelAlign="right" style="width:100%">' +
							'</div>' +
							'<div style="margin-bottom:20px">' +
							'<input class="easyui-combobox link-target" label="Target:" labelAlign="right" panelHeight="auto" data-options="editable:false,data:[{value:\'\',text:\'None\'},{value:\'_blank\',text:\'New Window\'}]" style="width:100%">' +
							'</div>' +
							'</div>';
					var te = $(this).texteditor('getEditor');
					var dlg = te.texteditor('getInsertDialog', {
