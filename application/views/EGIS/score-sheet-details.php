...
<div id="tabpanel" class="easyui-tabs" style="width:100%;max-width:100%;">
	...
	<div title="First grading" style="padding:10px;">
	  <table id="dg1" class="easyui-datagrid" title="<?php echo " TERM: <u>" . $_SESSION['sy'] . "</u>"; ?>, <?php echo " Section: <u>" . $sectionCode . "</u>"; ?>, <?php echo " Subject: <u>" . $subjectDescription . "</u>"; ?>" style="width:auto;height:1000px"
				data-options="
					iconCls: 'icon-edit',
					singleSelect: true,
					toolbar: '#tb',
	...
	<div title="Second Grading" style="padding:10px;">
