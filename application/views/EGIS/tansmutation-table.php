<div class="level1">
    ...
    <table id="dg" class="easyui-datagrid" title="Transmutation Table for <?php echo " TERM: " . $_SESSION['sy']; ?>" style="width:100%;height:450px"
            data-options="
                iconCls: 'icon-edit',
                singleSelect: true,
                toolbar: '#tb',
                url: 'getTransmutationEGIS',
                method: 'get',
        ...
        <thead>
            <tr>
				...
				<th data-options="field:'lowScore',width:80,align:'right',editor:{type:'numberbox',options:{precision:2}}">Low Score</th>   
				<th data-options="field:'highScore',width:80,align:'right',editor:{type:'numberbox',options:{precision:2}}">High Score</th>   
				<th data-options="field:'transmutedScore',width:120,align:'right',editor:{type:'numberbox',options:{precision:2}}">Transmuted Score</th>   
    ...
    <script type="text/javascript">
		...
		function addRecord(row) {
			jQuery.ajax({
				url: "insertTrasmutationEGIS",
				data: { 
					'lowScore': row.lowScore, 
					'highScore': row.highScore, 
					'transmutedScore': row.transmutedScore, 
				},
				type: "POST",
