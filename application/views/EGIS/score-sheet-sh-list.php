...
<table id="tt" class="easyui-datagrid" style="width:100%;max-width:100%;padding:5px 5px;font-size: 5px;"
        url="getMySeniorHighSectionsEGIS" toolbar="#tb"
        title="My Senior High Sections List for the term <?php echo '<b><u>' . $_SESSION['sy'] . '</u></b>'; ?>" iconCls="icon-save"
    ...
    $('#tt').datagrid({
        ...
        onClickRow: function() {
           ...
           // $('#tt').datagrid('enableCellEditing');
            ...
            jQuery.ajax({
            url: 'EGIS/showScoreScheetSHDetails',
            data: { 
    ...
    $('#tt').datagrid({
        ...
        onClickRow: function() {
           ...
           // $('#tt').datagrid('enableCellEditing');
            ...
            /*jQuery.ajax({
            url: 'EGIS/showScoreScheetDetails',
            data: { 
				'sectionCode' : row.sectionCode,
				'subjectCode' : row.subjectCode,
				'subjectDescription' : row.subjectDescription,
  ...
  afterChange: function (change, source) {
   ...
   function CustomViewGradesSummary(){
        this.render = function(sectionCode, subjectCode, subjectDescription){
            ...
            document.getElementById('dialogboxhead-long').innerHTML = 'View PDF... <button onclick="ViewGradesSummary.no()">Close</button> <button onclick="ViewGradesSummary.post()">POST</button>';
