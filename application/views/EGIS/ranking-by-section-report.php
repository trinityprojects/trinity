...
$pdf->SetHeaderData(false, false, 'Ranking by Section: ' . $sectionCode, false);
...
$tbl.=<<<EOD
      <td width="8%">Weighted Average</td>
	</tr>
EOD;
...
$tbl.=<<<EOD
      <td align="right" width="8%">$weightedAverage</td>
EOD;
...
$filename= "rankingBySection". $sectionCodeNS . ".pdf"; 
