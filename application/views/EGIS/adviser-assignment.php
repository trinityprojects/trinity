...
<div id="tabpanel" class="easyui-tabs" style="width:100%;max-width:100%;">
	...
	<div title="Sections" style="padding:10px;">
	  <table id="dg" class="easyui-datagrid" title="Section Adviser Assignment for <?php echo " TERM: " . $_SESSION['sy']; ?>" style="width:auto;height:450px"
				data-options="
					iconCls: 'icon-edit',
					singleSelect: true,
					toolbar: '#tb',
			...
			<thead>
				<tr>
					...
					<th data-options="field:'sectionCode',width:200">Section Code</th>
					<th data-options="field:'courseDescription',width:150">Course</th>
    ...
    <script type="text/javascript">
		...
		function updateRecord(row, i) {
			jQuery.ajax({
				url: "updateAdviserAssignmentEGIS",
				data: { 
					'ID': row.ID, 
