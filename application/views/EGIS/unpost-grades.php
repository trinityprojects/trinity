...
<div id="tabpanel" class="easyui-tabs" style="width:100%;max-width:100%;">
	...
	<div title="UNPOST" style="padding:10px;">
	  <table id="dg" class="easyui-datagrid" title="UNPOST GRADES for <?php echo " TERM: " . $_SESSION['sy']; ?>. You can only unpost here" style="width:auto;height:450px"
				data-options="
					iconCls: 'icon-edit',
					singleSelect: true,
					toolbar: '#tb',
					url: 'getGradesPostingEGIS',
					method: 'get',
			...
			<thead>
				<tr>
					...
					<th data-options="field:'sectionCode',width:150">Section</th>
					<th data-options="field:'subjectCode',width:100">Subject</th>
