<div class="level1">
    ...
    <div id="p" class="easyui-panel" title="Request Created" style="width:100%;height:450px;padding:10px;">
...
<div class="two-column-70">
    <p><h5>You may attach files for this request</h5></p>
	<p><h3>(Please make sure the filenames has no spaces and has gif|jpg|png|pdf|jpeg extensions and is below  3000 KB in size).</h3></p>
