...
<div class="materials-estimate" id="autocomple-input">
    ...
    <input type="text" class="price" id="numericPrice<?php echo $ctr; ?>" name="price[]" size="15" maxlength="15" placeholder="Price" onBlur="checkBlankFieldPrice();"/> 
    ...
    <a href="#" class="remove_field_with_price" id="basic-btn-delete">Remove<?php echo $ctr; ?></a>
...
$(document).ready(function(){
    ...
    $('#numericPrice<?php echo $ctr; ?>').focus();
    $('[id^=numericPrice]').keypress(validateNumber);
...
function validateQuotes(event) {
    ...
    if (event.keyCode === 8 || event.keyCode === 46) {
      ...
      function checkBlankFieldPrice() {
          console.log($('#numericPrice<?php echo $ctr; ?>').val());
        if (!$('#numericPrice<?php echo $ctr; ?>').val())         {
            $('#numericPrice<?php echo $ctr; ?>').focus();
           return (false);
        }
        return (true);
