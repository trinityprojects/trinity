   ...
   function CustomViewJobOrder(){
    ...
    function CustomCompletedJobOrder(){
        this.render = function(requestID,jo,status){
            ...
            document.getElementById('dialogboxbody').innerHTML = dialog;
            document.getElementById('dialogboxfoot').innerHTML = '<button onclick="CompletedJobOrder.yes(\''+jo+'\',\''+status+'\',\''+requestID+'\',\''+specialInstructions+'\',\''+scopeDetails+'\',\''+requestStatusRemarksID+'\',\''+startDateActual+'\',\''+receivedDate+'\')">Proceed</button> <button onclick="CompletedJobOrder.no()">Close</button>';
        }
        this.no = function(){
        ...
        this.yes = function(jo, status, requestID, specialInstructions, scopeDetails, requestStatusRemarksID, startDateActual, receivedDate ){
            updateRequestComplete(jo, status, requestID, specialInstructions, scopeDetails, requestStatusRemarksID, startDateActual, receivedDate);
            document.getElementById('dialogbox').style.display = "none";
            document.getElementById('dialogoverlay').style.display = "none";
        }
    }
    ...
    function updateRequestComplete(jo, status, requestID, specialInstructions, scopeDetails, requestStatusRemarksID, startDateActual, receivedDate) {
            jQuery.ajax({
