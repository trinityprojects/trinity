<div class="level1">
            ...
            <div style="margin-bottom:5px">
                <div style="margin-bottom:1px" >
                    <input class="easyui-combobox" name="locationCode" id="locationCode" style="width:100%" prompt="LOCATION:" data-options="
                            url:'getLocationCodeTBAMIMS',
                            method:'get',
                            valueField:'locationCode',
                            textField:'locationDescription',
                            onSelect: function(rec){
                                var url = 'getFloorTBAMIMS?locationCode='+rec.locationCode;
                ...
                <div style="margin-bottom:1px" class="two-column-30">
                    <input class="easyui-combobox" name="floor" id="floor" style="width:70%" prompt="FLOOR:" data-options="
                            ...
                            textField:'floor',
                            onSelect: function(rec){
                                var url = 'getRoomNumberTBAMIMS?floor='+rec.floor+'&locationCode='+rec.locationCode;
                                $('#roomNumber').textbox('clear');
                                $('#roomNumber').combobox('reload', url);
                            },
   ...
   <div id="dlg" class="easyui-dialog" title="Create New Request Confirmation" style="position:relative; top:20px; width:1000px; height:500px; padding:10px"
	...
	<script src="<?php echo base_url();?>assets/scripts/building/tbamimscreaterequest.js"></script>
	<style type="text/css">
		.textbox-text{
			background: #fffec8;
			font-weight: bold;
