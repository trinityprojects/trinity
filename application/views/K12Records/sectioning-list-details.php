<div class="level2">
	...
	<link rel="stylesheet" href="<?php echo base_url();?>assets/stylesheets/purchasing/asrs.css" />
	  ...
	  <table id="dg1" class="easyui-datagrid" title="<?php echo " TERM: <u>" . $_SESSION['sy'] . "</u>"; ?>" style="width:auto;height:450px"
				data-options="
					...
					singleSelect: true,
					toolbar: '#tb',
					url: 'getSeniorHighStudentsListK12Records',
					method: 'get',
					onClickCell: onClickCell,
					onEndEdit: onEndEdit,
                    queryParams:{courseCode:'<?php echo $courseCode;?>'
					}"  
				">
					...
					<th data-options="field:'sectionCode',width:250,
							...
							editor:{
								...
								options:{
									...
									method:'get',
									url:'getSectionByCourseSHK12Records',
									queryParams:{courseCode:'<?php echo $courseCode;?>'
									},  
									required:true
								}
    ...
    <script type="text/javascript">
		...
		function updateRecord(row, i) {
			console.log(row);
			jQuery.ajax({
				url: "updateSectioningSeniorHighK12Records",
				data: { 
					'row': row, 
					'i': i, 
				},
