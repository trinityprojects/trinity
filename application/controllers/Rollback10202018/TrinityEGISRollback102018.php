    ...
    public function showRankingBySectionEGIS() {
		...
		if(empty($results)) {
			...
			$results = $this->_getRecordsData($dataSelect1 = array($selectFields), 
				...
				if(empty($results)) {
					...
					$results = $this->_getRecordsData($dataSelect1 = array($selectFields), 
						$tables = array('triune_section_senior_high', 'triune_subject_senior_high'), $fieldName = array('triune_section_senior_high.sectionCode'), $where = array($sectionCode), 
		...
		if($gradingPeriod == '1') {
			...
			$recordCount = $this->_getRecordsData($dataSelect1 = array('studentNumber'), 
					...
					$fieldName = array('triune_grades_score_sheet_2_summary.sectionCode'), 
					$where = array($sectionCode),$join = null, $joinType = null, $sortBy = null, $sortOrder = null, $limit = null, 
					$fieldNameLike = null, $like = null, $whereSpecial = null, $groupBy = null );
		...
		if(empty($resultsHead)) {
			...
			$resultsHead = $this->_getRecordsData($dataSelect1 = array($selectHead), 
				...
				if(empty($resultsHead)) {
					...
					$resultsHead = $this->_getRecordsData($dataSelect1 = array($selectHead), 
						$tables = array('triune_section_senior_high', 'triune_subject_senior_high'), $fieldName = array('triune_section_senior_high.yearLevel'), 
						$where = array($yearLevel), $join = array('triune_section_senior_high.subjectCode = triune_subject_senior_high.subjectCode'), 
						$joinType = array('inner'), $sortBy = array('displaySequence'), $sortOrder = array('asc'), $limit = null, 
						$fieldNameLike = null, $like = null, $whereSpecial = null, $groupBy = null );
				}
		}
		...
		if(empty($recordCount)) {
			...
			if(empty($recordCount)) {
				...
				if($gradingPeriod == '1') {
					...
					$recordCount = $this->_getRecordsData($dataSelect1 = array('triune_grades_score_sheet_2.studentNumber'), 
						$tables = array('triune_section_senior_high', 'triune_grades_score_sheet_2'), $fieldName = array('triune_section_senior_high.yearLevel'), 
						$where = array($yearLevel), $join = array('triune_section_senior_high.sectionCode = triune_grades_score_sheet_2.sectionCode'), 
						$joinType = array('inner'), $sortBy = null, $sortOrder = null, $limit = null, $fieldNameLike = null, $like = null, $whereSpecial = null, 
						$groupBy = null );
				}
			}
